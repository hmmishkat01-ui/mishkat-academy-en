                                    ...
                                    {enrollment.discount_amount > 0 && (
                                        <>
                                            <div className="flex justify-between text-red-600">
                                                <span>
                                                    Discount ({enrollment.discount_type === 'percentage' ? `${enrollment.discount_value}%` : 'Fixed'}):
                                                </span>
                            ...
                            {enrollment.discount_amount > 0 && enrollment.discount_reason && (
                                <div className="mb-4 p-3 bg-blue-50 border-l-4 border-blue-500 rounded">
                                    ...
                                    <p className="text-sm font-medium text-slate-700">
                                        {enrollment.discount_type === 'percentage' ? `${enrollment.discount_value}%` : `৳${enrollment.discount_value}`} Discount applied করা হয়েছে
                                    </p>
                                </div>
                            )}
